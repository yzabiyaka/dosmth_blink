...
class CustomerIoCampaignSignupPostMessage extends Message {
  constructor(...args) {
    super(...args);
  ...
  static fromCtx(ctx) {
    ...
    const message = new CustomerIoCampaignSignupPostMessage({
...
module.exports = CustomerIoCampaignSignupPostMessage;
